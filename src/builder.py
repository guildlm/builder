...
def _generate_prompt(
    ...
    test_rule = (
        ...
        "instance of the system under test (a new store/server/handler) — never "
        "share one mutable instance across cases, or state left by an earlier case "
        "makes a later one fail spuriously. But a fresh instance is EMPTY, and "
